...
<div class="box">
		...
		<input name="id" value="<?php echo $data['id']; ?>"  hidden />
				<h2>Edit Data Usaha Alumni</h2>
						...
						<div class="inputBox">
							<input type="text" required="required" name="nama_usaha" value="<?php echo $data['nama_usaha'];?>" required>
							<span>Nama Usaha</span>
							<i></i>
						</div>
						<div class="inputBox">
							<input type="text" required="required" name="kategori" value="<?php echo $data['kategori'];?>" required>
							<span>Kategori</span>
							<i></i>
						</div>
						...
						<a class="login100-form-btn" style="margin-left:5px;" href="../usaha.php">Kembali</a>
