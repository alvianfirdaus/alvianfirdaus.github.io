...
<body>
    ...
    <div class="sidebar transition overlay-scrollbars">
        <div class="logo">
            <h2 style="font-weight: 700;" class="mb-0">Simfoni<span style="font-weight: 500;">Admin</span></h2>
        </div>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php } ?>
                        <div class="mb-3">
                            <a href="crudalumni/tambah.php" class="btn btn-primary btn-icon"><i class="fas fa-plus"></i>
                                Tambah Data</a>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    while ($log = mysqli_fetch_assoc($querydata)) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo $log['prodi']; ?></td>
                                            <td><?php echo $log['jurusan']; ?></td>
                                            <td><?php echo $log['tahun_lulus']; ?></td>
                                            <?php if ($log['gambar'] != "") { ?>
                                                <td><a href="crudalumni/lihat.php?id=<?php echo $log['id']; ?>"><img src="crudalumni/gambar/<?php echo $log['gambar']; ?>" style="width:50px;"></a></td>
                                            <?php } ?>
                                            <?php if ($log['gambar'] == "") { ?>
                                                <td>Tidak ada gambar</td>
                                            <?php } ?>
                                            <td class="text-center"><a href="crudalumni/edit.php?id=<?php echo $log['id']; ?>" class="btn btn-warning btn-icon"><i class="fas fa-edit"></i> Edit</td>
                                            <td class="text-center"><a href="crudalumni/hapus.php?id=<?php echo $log['id']; ?>" class="btn btn-danger btn-icon" onclick="return confirm('Yakin ingin hapus data?')"><i class="fas fa-trash-alt"></i> Hapus</td>
                                        </tr>
                                    <?php
                                    }
                                    ?>
