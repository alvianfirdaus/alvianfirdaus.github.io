...
<head>
    ...
    <title>Dokumen Informasi Alumni Politeknik Negeri Malang</title>
        ...
        <div class="album py-5 bg-light">
            <div class="container">
                <div class="row">
                    ...
                    $query = mysqli_query($connect, "SELECT * FROM kerja");
                    $totalquery = mysqli_num_rows($query);
                    $totalpaging = ceil($totalquery / $limit);

                    $querydata = mysqli_query($connect, "SELECT * FROM kerja ORDER BY id DESC limit $main_page, $limit");
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <?php
                                            if ($row['gambar'] != "") { ?>
                                        <a type="button"
                                            href="../admin/crud/lihat.php?id=<?php echo $row['id']; ?>"
