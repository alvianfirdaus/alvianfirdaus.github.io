...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-8 col-md-7 py-4">
                        ...
                        <p class="text-muted">Sistem Informasi Alumni Politeknik Negeri Malang</p>
                    </div>
                    <div class="col-sm-3 offset-md-1 py-4">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a href="index.php" class="text-white">Alumni</a></li>
                            <li><a href="kerja.php" class="text-white">Kerja</a></li>
        ...
        <div class="navbar navbar-dark bg-dark box-shadow">
            <div class="container d-flex justify-content-between">
                <a href="#" class="navbar-brand d-flex align-items-center">
                    ...
                    <strong>Dokumentasi Informasi Alumni Politeknik Negeri Malang</strong>
                </a>
    ...
    <main role="main">
        ...
        <section class="jumbotron text-center">
            <div class="container">
                <h1 class="jumbotron-heading">Selamat datang di Sistem Informasi Alumni Politeknik Negeri Malang</h1>
                <p class="lead text-muted">Menampilkan Data <strong>Alumni</strong></p>
            </div>
        </section>
        ...
        <div class="album py-5 bg-light">
            <div class="container">
                <div class="row">
                    ...
                    $query = mysqli_query($connect, "SELECT * FROM alumni");
                    $totalquery = mysqli_num_rows($query);
                    $totalpaging = ceil($totalquery / $limit);

                    $querydata = mysqli_query($connect, "SELECT * FROM alumni ORDER BY id DESC limit $main_page, $limit");
                    $no = 1;
                    ...
                    ?>
                        <div class="col-md-4">
                            <div class="card mb-4 box-shadow">
                                ...
                                if ($row['gambar'] != "") { ?>
                                    <center>
                                        <img class="card-img-top" style="width:200px;height:220px;" src="../admin/crudalumni/gambar/<?php echo $row['gambar']; ?>" alt="Card image cap">
                                    </center>
                                <?php } ?>
                                <div class="card-body">
                                    <p class="card-text">Nama: <?php echo $row['nama']; ?></p>
                                    <p class="card-text">Prodi: <?php echo $row['prodi']; ?></p>
                                    <p class="card-text">jurusan: <?php echo $row['jurusan']; ?></p>
                                    <p class="card-text">Tahun Lulus: <?php echo $row['tahun_lulus']; ?></p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            <?php
                                            if ($row['gambar'] != "") { ?>
                                                <a type="button" href="../admin/crudalumni/lihat.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-outline-primary">Lihat</a>
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
