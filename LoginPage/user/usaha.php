        ...
        <div class="album py-5 bg-light">
            <div class="container">
                <div class="row">
                    ...
                    $query = mysqli_query($connect, "SELECT * FROM usaha");
                    $totalquery = mysqli_num_rows($query);
                    $totalpaging = ceil($totalquery / $limit);

                    $querydata = mysqli_query($connect, "SELECT * FROM usaha ORDER BY id DESC limit $main_page, $limit");
                    $no = 1;
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 box-shadow">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Nama Usaha: <?php echo $row['nama_usaha']; ?></p>
